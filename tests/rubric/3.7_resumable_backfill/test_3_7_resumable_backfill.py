...
def test_crash_before_and_after_commit_retains_a_resumable_partial_shadow(tmp_path):
    ...
    clean = lab.run_clean()
    crashed = lab.run_with_fault("incremental_chunk_after_shadow_write_before_progress")
