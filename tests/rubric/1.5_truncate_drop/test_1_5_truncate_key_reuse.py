...
Both reviews landed here independently. `tests/rubric/1.5_truncate_drop/test_1_5_truncate_fold.py`
covers rows-before / rows-after / keyless / spilled / multi-table / rolled-back
truncates, and `tests/rubric/1.4_pk_updates/` covers every key-reuse shape — but no test
...
import pytest
from support.applier_lab import DATASET, Lab, data, end, keyed, truncate
