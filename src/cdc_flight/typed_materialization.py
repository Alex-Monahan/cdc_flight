...
def _arrow_route(
    ...
    *,
    ...
    for index, column in enumerate(columns):
        ...
        if any(_contains_postgres_infinity(row[index]) for row in rows):
            return None
